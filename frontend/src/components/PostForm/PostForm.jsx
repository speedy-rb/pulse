      ...
      <form className={styles.postForm}>
        ...
        <div className={styles.formRow}>
          <div className={styles.fieldHeaderRow}>
            ...
            <input placeholder='Friday, April 11' />
          </div>
          <div className={styles.fieldWidgetRow}>
        ...
        <div className={styles.formRow}>
          <div className={styles.fieldHeaderRow}>
            ...
            <input type='url' placeholder='Add location (ex. https://maps.google...)' />
          </div>
        </div>
        {/* Add notes */}
        <div className={styles.formRow}>
          <div className={styles.fieldHeaderRow}>
            ...
            <textarea className={styles.formTextArea} placeholder='Add notes'></textarea>
          </div>
        </div>
      </form>
    </div>
